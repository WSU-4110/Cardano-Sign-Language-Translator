...
def test_create_usertable():
   expected = True
   self.assertEqual(expected, "Testing created user table" )

def test_add_userdata(username,password):
    expected = True
    self.assertEqual(expected, "Testing added users")

def test_login_user(username,password):
    expected = True
    self.assertEqual(expected, "Testing login")

def test_view_all_users():
    expected = True
    self.assertEqual(expected, "Testing view all users")
def test_Menu():
    expected = True
    self.assertEqual(expected, "Testing if menu works")
