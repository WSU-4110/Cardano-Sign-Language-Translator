This is the working version of the app which includes all of the necessary files needed to run it. Some of these files can be found in other folders in the repo as well.
